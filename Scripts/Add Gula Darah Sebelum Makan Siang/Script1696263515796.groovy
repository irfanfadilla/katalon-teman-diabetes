...
Mobile.tap(findTestObject('GulaDarahManualPage/android.widget.CheckedTextView - Sebelum Makan Siang'), 0)
...
Mobile.scrollToText('Silahkan isi disini', FailureHandling.STOP_ON_FAILURE)

Mobile.sendKeys(findTestObject('GulaDarahManualPage/SnackSebelumnya'), 'Wafer')
