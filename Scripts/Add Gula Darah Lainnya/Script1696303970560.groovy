...
Mobile.tap(findTestObject('GulaDarahManualPage/android.widget.CheckedTextView - Lainnya'), 0)
...
Mobile.verifyElementText(findTestObject('GulaDarahManualPage/WaktuPopup'), 'Lainnya')
